...
class AnomalyDetector:
    ...
    def run(self):
        ...
        # LSTM autoencoder
        checkpoint = torch.load('/data/ephemeral/home/level2-3-cv-finalproject-cv-06/model/pts/LSTM_20240324_222238_best.pth')
        autoencoder_model = LSTMAutoEncoder(num_layers=2, hidden_size=50, n_features=n_features,
                            device=device)
        ...
        while cap.isOpened():
            ...
            if success:
                ...
                if results[0].boxes is not None:  # Check if there are results and boxes
                    ...
                    self.display_text(annotated_frame, anomaly_text, (10, 30))  # Display the anomaly text
